...
//            LOG.error(e);
     ...
     */
    public static PsiExpression[] getArrayInitializersToFlattenInVarargs(PsiCall expression) {
    ...
    public static boolean isSafeToFlattenToVarargsCall(@NotNull final PsiCall callExpression,
                                                       @NotNull final PsiExpression[] arrayElements) {
    ...
    private static PsiExpression [] getInitializers(@NotNull final PsiNewExpression newExpression) {
